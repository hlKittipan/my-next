...
export const getStaticProps = () => {
  const articles = [
    ...
    },
    {
      ...
      content:
        "risus eu lectus a consectetur aliquam nullam enim tellus urna nunc sagittis aenean aliquam ullamcorper consectetur dictumst sit, placerat eget lobortis eget elit nibh blandit scelerisque consectetur condimentum diam tempor. nisl erat semper gravida tempor aliquam suscipit a viverra molestie sit porta cras ultricies, fermentum habitasse sit semper cum eu eget lacus purus viverra cursus porttitor nisi nisl.",
      thumbnail:
        "https://blogthing-strapi.cleggacus.com/uploads/0_d65573c0b9.jpg",
    },
  ];
